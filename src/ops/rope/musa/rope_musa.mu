...
void launchRoPE(
    ...
    ropeKernel<<<gridSize(pair_count), MUSA_BLOCK_SIZE>>>(
...
void rope(std::byte *out, const std::byte *in, const std::byte *pos_ids,
    ...
    case LLAISYS_DTYPE_BF16:
        return launchRoPE<__mt_bfloat16>(out, in, pos_ids, seq_len, n_heads, head_dim, theta);
    default:
