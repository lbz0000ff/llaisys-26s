...
void launchSelfAttention(
    ...
    selfAttentionKernel<<<grid, CUDA_BLOCK_SIZE, kv_len * sizeof(float)>>>(
        ...
        value_dim,
        scale);
    checkCudaLaunch("self_attention kernel");
}
} // namespace
...
void selfAttention(
    ...
    case LLAISYS_DTYPE_BF16:
        return launchSelfAttention<__nv_bfloat16>(out, q, k, v, query_len, kv_len, n_heads, n_kv_heads,
                                                  qk_dim, value_dim, scale);
    default:
